...
#填写收入
    def varibles_incomeconfirm(self):
...
#共借人信息
    def varibles_isOnTheTitle(self):
...
#其房产信息确认
    def varibles_ownCurrentEstate(self):
    ...
    #situation填写
    def varibles_situationsave(self):
